...
<body>
    ...
    <form action="<?php echo e(route('issue.update', $issue->id)); ?>" method="POST" style="margin: 50px 50px">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" class="form-control" id="reported_date" name="reported_date" value="<?php echo e($issue->reported_date); ?>" required>
        </div>
        <div class="mb-3">
...
</body><?php /**PATH C:\xampp\htdocs\TH4\QUANLYPHONGTHUCHANHTINHOC\resources\views/issue/edit.blade.php ENDPATH**/ ?>